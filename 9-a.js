...
function compute(instructions){
    ...
    for(let i=0;i<instructions.length;)
    {
        ...
        if(opcode === 3){
            data[parameterModeOne === 2 ? data[i+1] + relativeBase : data[i+1]] = input;
            i+=2;
            continue;
        }
        if(opcode === 4){
