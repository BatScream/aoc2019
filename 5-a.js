...
function calc(data){
    ...
    for(let i=0;i<ins.length;)
    {
        ...
        const one = parameterModeOne? data[i+1] : data[data[i+1]];
        const two = parameterModeTwo? data[i+2] : data[data[i+2]];
        if(opcode === 5){
            if(one){
                i = two;
            }
